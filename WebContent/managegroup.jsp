...
<div id="container">
    ...
    <div class="d_blow">
        <div id="people">
            <input id="Rgroup_c_id" name="group_c_id" type="text" value="<%=g_info.getGroup().getC_id() %>"
                   hidden="hidden">
                        ...
                        <div class="modal-content">
                            <form class="frm1" action="AddG_PServlet">
                                <div class="modal-header">
                                    ...
                                    <input type="text" name="add_group_id" hidden="hidden"
                                           value="<%=g_info.getGroup().getId()%>">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="list_min_chat">
                                        <input type="checkbox" class="delete" name="jszzdm_add"
            ...
            <form class="frm1" action="DeleteG_PServlet" onsubmit="return check()">
                ...
                <input id="group_id" name="group_id" type="text" value="<%=g_info.getGroup().getId() %>"
                       hidden="hidden">
                ...
                <div id="blow_persons">
                    ...
                    %>
                    <div class="list_min_chat">
                        <input type="checkbox" class="delect" name="jszzdm"
                               value="<%=g_info.getList().get(i).getId()%>">
        ...
        <div id="file">
            <form action="DoFileUploadServlet?g_id=<%=g_info.getGroup().getId() %>" method="post"
                ...
                <div class="file_body">
                    <table class="FileTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="DownLoadServlet?fileName=<%=filelist.get(i).getName()%>&g_id=<%=g_info.getGroup().getId() %>"><%=filelist.get(i).getName() %>
                                </a></td>
                            <td><%=filelist.get(i).getC_name()%>
                            </td>
                            <td><%=filelist.get(i).getC_date() %>
                            </td>
                        </tr>
                        <%
                            }
