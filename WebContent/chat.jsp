        ...
        <div id="list">
            <div id="list_top">
                ...
                <div id="list_search_bar">
                    ...
                    <input id="search_input" type="text" placeholder="搜索" onkeyup="showHint(this.value)"
                           onblur="onblur1()" onfocus="showHint(this.value)"
                           onkeypress="if(event.keyCode==13) {toshowperson();return false;}">
                    <table id="mytable">
                    </table>
                </div>
            ...
            <div id="list_blow" border:0px solid;>
                ...
                %>
                <div class="list_min_chat" ondblclick="goChat1(<%=list2.get(i).getId()%>)"
                     onclick="show1('<%=list2.get(i).getId()%>','<%out.print(list2.get(i).getName());%>','<%if(user.getId().equals(list2.get(i).getC_id())){out.print("1");}else{out.print("0");}%>')">
                    <div class="list_min_chat_avatar">
                        <img src="images/qun.png"></a>
                    </div>
                    <div class="list_min_chat_ext">
                        <p><%=list2.get(i).getN_m_date()%>
                        </p>
                ...
                %>
                <div class="list_min_chat" ondblclick="goChat2(<%=list.get(i).getId()%>)"
                     onclick="show2('<%=list.get(i).getId() %>','<%=list.get(i).getNickName()%>')">
                    <div class="list_min_chat_avatar">
                        <img src="<%=list.get(i).getHeadImage()%>"></a>
                    </div>
                    <div class="list_min_chat_ext">
                        <p><%=list.get(i).getN_m_date()%>
                        </p>
                        <a class="wechat_no-remind"></a>
                    </div>
                    <div class="list_min_chat_info">
        ...
        <div id="chatArea">
            ...
            <div class="Message" id="Message">
                ...
                <div class="f_contact">
                    ...
                    <div class="f_message">
                        <p><%=mgm.getList().get(i).getContent() %>
                        </p>
                    </div>
                </div>
                <%
            ...
            <div class="chatArea_blow">
                ...
                <div id="chatArea_tool">
                    ...
                    <a class="wechat_screencut" mm-action-track="" track-type="['click']" ng-click="screenShot()"
                       href="javascript:;" title="截屏">
                    </a>
                    <a id="wechat_file" mm-action-track="" track-type="['click']" onclick="popWindows()"
                       href="javascript:;" title="文件和图片">
                    </a>
                </div>
                <%
                } else {
                ...
                <div id="chatArea_tool">
                    ...
                    <a id="wechat_file" mm-action-track="" track-type="['click']" ng-click="sendClick($event)"
                       href="javascript:;" title="文件和图片">
                    </a>
                </div>
                <%
